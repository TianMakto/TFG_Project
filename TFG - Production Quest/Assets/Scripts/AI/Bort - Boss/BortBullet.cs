...
public class BortBullet : MonoBehaviour
{
    [SerializeField]
    ...
    protected virtual void Start()
    {
        ...
        GetComponent<BortBulletBehaviuour>().BulletCreated(gameObject);
    ...
    {
        GetComponent<BortBulletBehaviuour>().BulletHitEffect(gameObject);
        ...
        if (go != null)
        {
            ...
            {
                GetComponent<BortBulletBehaviuour>().DamagedPlayer(go);
                go.GetComponent<Life>().SufferDamage(Damage, DamageType.normal);
        ...
        if (HitsToDestroy > 0)
        {
            ...
            if (HitsToDestroy <= 0)
            {
                GetComponent<BortBulletBehaviuour>().BulletDestroy(gameObject);
